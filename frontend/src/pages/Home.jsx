  ...
  <div class="container">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <p class="lh-lg">WISDOM SPROUT SCALEFUL is one of the BEST developer websites that provide web designers and developers with a simple way to preview and download a variety of free code &amp; scripts.</p>
                      <i class="fa fa-quote-right" aria-hidden="true"></i><br/>
                    </div>
          <div class="row">                    
           <div class="col-sm-2 pt-3">
             <img src="nagesh.jpg" class="rounded-circle img-responsive img-fluid"/>
                        </div>                   
              <div class="col-sm-10">
            <div class="arrow-down d-none d-lg-block"></div>
             <h4><strong>Nagesh Jayache</strong></h4>
   ...
   <img src="https://source.unsplash.com/300x300/?man" class="rounded-circle img-responsive img-fluid"/>
           ...
           <div class="col-sm-10">
            <div class="arrow-down d-none d-lg-block"></div>
             <h4><strong>Rushikesh Takalkar</strong></h4>
          ...
          <span>Vaxa digital</span>
               ...
               <div class="carousel-item">
                   <div class="row p-4">
                    <div class="t-card">
                    <i class="fa fa-quote-left" aria-hidden="true"></i>
                    <p class="lh-lg">WISDOM SPROUT SCALEFUL is one of the BEST developer websites that provide web designers and developers with a simple way to preview and download a variety of free code"Sed ut .</p>
                      <i class="fa fa-quote-right" aria-hidden="true"></i><br/>
                    </div>
                    <div class="row text-lg-start">
                    <div class="col-sm-2 pt-4 align-items-center">
                        <img src="https://static.toiimg.com/thumb/msid-72988628,width-1200,height-900,resizemode-4/.jpg" class="rounded-circle img-responsive img-fluid"/>
                        </div>
                        <div class="col-sm-10">
                          <div class="arrow-down d-none d-md-block"></div>
                        <h4><strong>rohit Sharma</strong></h4>
                        <p class="testimonial_subtitle"><span>
      Sport Person</span><br/>
          <span>Vaxa digital</span>
                </p>
                    </div>
                    </div>
